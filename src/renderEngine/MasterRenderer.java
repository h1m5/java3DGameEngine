...
public class MasterRenderer {
    ...
    public static final float RED = 0.74902f;
    public static final float GREEN = 0.847059f;
    ...
    public void renderScene(List<Entity> entities, List<Entity> normalMappedEntities, List<Terrain> terrains, List<Light> lights,
